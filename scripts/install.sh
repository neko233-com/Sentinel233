#!/usr/bin/env bash
# Sentinel233 Agent one-click installer for Linux/macOS/Windows-MSYS
# Usage: curl -fsSL https://raw.githubusercontent.com/neko233-com/Sentinel233/main/scripts/install.sh | bash
# Or:    curl ... | bash -s -- v0.1.0
set -euo pipefail
